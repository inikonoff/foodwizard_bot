...
5. Используй РАЗНООБРАЗНЫЕ ЕДИНИЦЫ ИЗМЕРЕНИЯ в зависимости от продукта:
   - Для мяса/рыбы/сыра: граммы (г), килограммы (кг)
   ...
   - Для масла: столовые ложки (ст. л.), миллилитры (мл.) жарки, для смазывания формы
...
[Проанализируй полученное блюдо на баланс вкусов (Жирное, Кислое, Соленое, Сладкое, Острое) и текстур (Мягкое/Хрустящее). Напиши короткий совет: чего не хватает для идеала в контексте кулинарной триады. Порекомендуй ТОЛЬКО ОДИН этот ингредиент! Пример: "Блюдо вышло жирным и мягким. Добавьте для баланса маринованный лук (кислота/хруст)."]"""

    res = await GroqService._send_groq_request(prompt, "Напиши рецепт с учетом всех правил", 0.3)
